...
test.census.scores <- get_data('scores', 'greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'sss', 'fdsfd', 'TEST', 5432)
test.census.new <- get_data('new', 'greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'fds', 'sfds', 'TEST', 5432)
test.census.all <- get_data('all', 'greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'fds', 'ssfds', 'TEST', 5432)
test.census.scores
test.census.new
test.census.all
```
...
mainfunction.scores('greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'fds', 'sfds', 'TEST', 5432)
```
...
mainfunction.new <- function(server, user, password, database, port){
  ...
  model.new <- nn.model.new('greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'fds', 'fds', 'TEST', 5432)
...
mainfunction.new('greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'fds', 'fds', 'TEST', 5432)
```
...
mainfunction.all <- function(server, user, password, database, port){
  ...
  model.all <- nn.model.new('greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'sdf', 'fds', 'TEST', 5432)
...
mainfunction.all('greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'fds', 'sdf', 'TEST', 5432)
