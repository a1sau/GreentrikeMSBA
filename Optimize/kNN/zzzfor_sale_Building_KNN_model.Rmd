...
```{r}
#This creates the connection to the database and returns the querry depending on if the user wants "scored" or "new" data.
...
```{r}
main_forsale_knn("bpope","BenWillNotCommitPasswordsToGithub","greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com","TEST")
```
